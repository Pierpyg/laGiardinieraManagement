...
<body>
    ...
    <form action="TableData1.php" method="post">
        <table id="tabella2">
            <tr>
                <th colspan="9"><br>LIST OF ITEMS FOR PURCHASE ORDER OFFICE<br><br></th>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="9"><input type="date" name="data"></td>
            </tr>
            <tr>
                <td colspan="9" class="spazio"><br></td>
            </tr>
            ...
            <tr>
                <td colspan="9" style="text-align: center;"><input type="text" name="note"></td>
            </tr>
            <tr>
                <td colspan="9" class="spazio"><br><br></td>
            </tr>
            <tr>
