...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Flag to check whether the entry was successful
    ...
    foreach ($quantita as $index => $quant) {
        ...
        if (!empty($quant)) {
            ...
            $sql_insert = "INSERT INTO table3 (Data, PuntoVendita, NomeRichiedente, Numero, Quantita, UM, 
            ...
            if ($conn->query($sql_insert) === TRUE) {
                // If the entry was successful, update the flag
