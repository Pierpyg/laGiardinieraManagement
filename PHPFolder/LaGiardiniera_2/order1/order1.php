...
<body>
    ...
    <form action="OrderData1.php" method="post">
    <h1>ORDER CONFIRMATION STORE:<input type="text" name="conferma_ordine_pv"></h1>
        ...
        <div class="table">
            ...
            <div>
                <table>
                    ...
                    <th><input class="note" type="text" name="nome_responsabile_pv" id=""></th>
                    <th><input class="note" type="text" name="firma_responsabile_pv" id=""></th>
                </table>
            </div>
        </div>
